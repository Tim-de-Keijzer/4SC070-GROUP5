function norm_error = Opti_fit_exp(x)

%% Global variables
global forwardGain backwardGain x_result

forwardGain         = x(1);  % clamp dimple width
backwardGain        = x(2);  % clamp dimple height
